...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
        ...
        const variants = {
            default: "bg-black text-white hover:bg-gray-800 shadow-lg shadow-gray-200/50",
            outline: "border border-gray-200 bg-transparent hover:bg-gray-50 text-gray-900",
            ghost: "hover:bg-gray-100 text-gray-900",
            link: "text-black underline-offset-4 hover:underline",
            // Redefined glow to be a subtle premium shadow instead of neon
            glow: "bg-black text-white hover:bg-gray-900 shadow-[0_0_20px_-10px_rgba(0,0,0,0.3)] hover:shadow-[0_0_30px_-5px_rgba(0,0,0,0.2)] transition-all duration-300",
        }
